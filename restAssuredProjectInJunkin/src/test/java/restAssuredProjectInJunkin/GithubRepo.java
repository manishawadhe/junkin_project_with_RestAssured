package restAssuredProjectInJunkin;
...
public class GithubRepo {
	...
	public static String token="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";
	JsonPath jsonpath;
...
//		System.out.println(res);
		...
		System.out.println("Created the repo");
	}
...
//					.header("Authorization", "Bearer "+token)
//					.when()
//					.delete("/repos/"+"Kaushiik-org-project-postman/new_fork456")
//					.then()
//					.assertThat()
//					.statusCode(204)
//					.extract().response();
